...
public class RPSLSpock {
    /***
     * @param makes random rock, paper, scissors, lizard or spock
     */
    ...
    /***
     * Boolean, determining that value is valid
     * @param pick determines if rock, paper, scissors, lizard or spock
     * @return picks false if null value
     */
    ...
    /***
     * Return generateed pick
     * @return picks either rock, paper,scissors, lizard or spock
     */
     ...
     * @param c_pick determines who to start the round with
     * @param h_pick determines who faces the c pick
     * @return determines winner of round
     */
